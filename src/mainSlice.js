...
export const mainSlice = createSlice({
    ...
    initialState: {
        ...
        file:{},
        listings: [
            { _id: 1, creation_date: '2023-11-09T14:30:00.000Z', url: 'https://i.imgur.com/jYK9TPZ.png', lat: 40.7128, lng: -74.0060, tags: ['table', 'console', 'large', 'vintage', 'antique'], description: 'A gently used console table for the kitchen', flag: false },
    ...
    reducers: {
        ...
        savePhoto: (state, action) => { // payload: { fileName, file }
